...
//
//	mockgen -source=interfaces/http_service_interface.go -destination=mocks/http_service_mocks.go -package=mocks
//
...
func (mr *MockHttpServiceMockRecorder) CalculateEloBounds(params any) *gomock.Call {
...
func (mr *MockHttpServiceMockRecorder) IsValidGameType(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// CalculateEloBounds indicates an expected call of CalculateEloBounds.
func (mr *MockGameServiceMockRecorder) CalculateEloBounds(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// IsValidGameType indicates an expected call of IsValidGameType.
func (mr *MockGameServiceMockRecorder) IsValidGameType(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
