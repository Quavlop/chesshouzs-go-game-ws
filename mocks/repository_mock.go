...
func (m *MockRepository) InsertPlayerIntoPool(params models.PlayerPoolParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InsertPlayerIntoPool", params)
	ret0, _ := ret[0].(error)
	return ret0
}

// InsertPlayerIntoPool indicates an expected call of InsertPlayerIntoPool.
func (mr *MockRepositoryMockRecorder) InsertPlayerIntoPool(params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertPlayerIntoPool", reflect.TypeOf((*MockRepository)(nil).InsertPlayerIntoPool), params)
}
...
// InsertPlayerIntoPool mocks base method.
func (m *MockMatchRepository) InsertPlayerIntoPool(params models.PlayerPoolParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InsertPlayerIntoPool", params)
	ret0, _ := ret[0].(error)
	return ret0
...
// InsertPlayerIntoPool indicates an expected call of InsertPlayerIntoPool.
func (mr *MockMatchRepositoryMockRecorder) InsertPlayerIntoPool(params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertPlayerIntoPool", reflect.TypeOf((*MockMatchRepository)(nil).InsertPlayerIntoPool), params)
}
